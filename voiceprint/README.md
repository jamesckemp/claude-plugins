...
Point it at a directory containing `SKILL.md` and `voice-profile.md` (generated by a previous `/voiceprint:generate` run). This enters refine mode where you can:
...
Applies the latest voiceprint template improvements to an existing writer skill without re-running the full generation process.
